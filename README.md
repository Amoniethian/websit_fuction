...
- **奖惩**：每 10/25/50/100/200 词产出小鱼/月亮鱼/小丑鱼/大鱼/水母（脉动漂浮）；番茄钟时长产出海草/海葵/珊瑚；超阈值凝成奖牌
...
- **音频**：Web Audio 合成的环境音（深海白噪 + 缓慢和声垫 + 气泡 / 水流）；反馈音用于答对 / 答错、新生物诞生、番茄结束、整套掌握；可**上传自己的音频做循环 BGM**（仅存本机）。各路独立开关 + 音量，设置本地持久化
