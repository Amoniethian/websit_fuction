                ...
                <div style="display:flex; gap:16px; flex-wrap:wrap; margin:15px 0;">
                    <div style="flex:1; min-width:200px;">
                        <div style="border:1px solid var(--border-color); border-radius:4px; overflow:hidden;">
                            <img src="/assets/images/heinrich-portrait.jpg" alt="Heinrich Hoffmann — Portrait" style="width:100%; display:block;">
                        </div>
                    ...
                    <div style="flex:1; min-width:200px;">
                        <div style="border:1px solid var(--border-color); border-radius:4px; overflow:hidden;">
                            <img src="/assets/images/heinrich-lucius-together.jpg" alt="Heinrich and Lucius Hoffmann" style="width:100%; display:block;">
                        </div>
        ...
        },
        {
            ...
            content: `
                ...
                <div style="margin:20px 0; background:#000; border-radius:8px; overflow:hidden;">
                    <video controls style="width:100%; display:block;" poster="/assets/images/scan-08.jpg">
                        <source src="/assets/images/aurora-briefing.mp4" type="video/mp4">
    ...
    tier4Entries: [
        {
            ...
            content: `
                ...
                <div style="margin:15px 0; border:1px solid var(--border-color); border-radius:4px; overflow:hidden;">
                    <img src="/assets/images/scan-01.jpg" alt="Scan 01 — Forged consent form" style="width:100%; display:block;">
                </div>
                ...
                <div style="margin:15px 0; border:1px solid var(--border-color); border-radius:4px; overflow:hidden;">
                    <img src="/assets/images/scan-02.jpg" alt="Scan 02 — Falsified compatibility report" style="width:100%; display:block;">
                </div>
                ...
                <div style="margin:15px 0; border:1px solid var(--border-color); border-radius:4px; overflow:hidden;">
                    <img src="/assets/images/scan-03.jpg" alt="Scan 03 — Heinrich's internal memo" style="width:100%; display:block;">
                </div>
        ...
        },
        {
            ...
            content: `
                ...
                <div style="margin:15px 0; border:1px solid var(--border-color); border-radius:4px; overflow:hidden;">
                    <img src="/assets/images/scan-05.jpg" alt="Scan 05 — Chord's subject profile" style="width:100%; display:block;">
                </div>
                ...
                <div style="margin:15px 0; border:1px solid var(--border-color); border-radius:4px; overflow:hidden;">
                    <img src="/assets/images/scan-06.jpg" alt="Scan 06 — Post-operative report" style="width:100%; display:block;">
                </div>
                ...
                <div style="margin:15px 0; border:1px solid var(--border-color); border-radius:4px; overflow:hidden;">
                    <img src="/assets/images/scan-07.jpg" alt="Scan 07 — Communication log" style="width:100%; display:block;">
                </div>
                ...
                <div style="margin:15px 0; border:1px solid var(--border-color); border-radius:4px; overflow:hidden;">
                    <img src="/assets/images/scan-08.jpg" alt="Scan 08 — Experiment protocol" style="width:100%; display:block;">
                </div>
