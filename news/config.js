...
const NEWS_CONFIG = {
    ...
    headline: {
        ...
        content: `
            ...
            <p>Notably, Lucius had in recent years avoided large public performances and professional adjudication panels. His management team attributed this to his "artistic philosophy." However, industry insiders have revealed that several music critics had previously raised questions about the originality of his compositions, though such discussions were swiftly suppressed.</p>
            <p class="cn">值得注意的是，Lucius近年来一直回避大型公开演出和专业评审。其经纪团队将此归因于他的"艺术理念"。然而，业内人士透露，此前已有多位乐评人对其作品的原创性提出质疑，但相关讨论均被迅速压制。</p>
