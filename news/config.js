...
const NEWS_CONFIG = {
    ...
    // Headline (Obituary)
    headline: {
        title: "Young Pianist Lucius Found Dead in Vienna Residence, Aged 28",
        titleCn: "青年钢琴家Lucius被发现死于维也纳寓所，年仅28岁",
        ...
        content: `
            ...
            <p class="cn"><strong>维也纳</strong>——青年钢琴家Lucius于11月14日晚间被发现死于其位于维也纳第一区的私人寓所，年仅28岁。维也纳警方表示，死因仍在调查中，尚未排除任何可能性。</p>
