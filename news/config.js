...
const NEWS_CONFIG = {
    ...
    // Headline (Obituary)
    headline: {
        title: "Young Pianist Lucius Found Dead in Vienna Residence",
        titleCn: "青年钢琴家Lucius被发现死于维也纳寓所",
        author: "Anna Weber",
        ...
        content: `
            <h3>C3</h3>
            <p class="lead"><strong>VIENNA</strong> — Young pianist Lucius was found dead in his private residence in Vienna's 1st District on the evening of November 14th. He was 28 years old. Vienna police have stated that the cause of death remains under investigation and no possibilities have been ruled out.</p>
            <p class="cn"><strong>维也纳</strong>——青年钢琴家Lucius于11月14日晚间被发现死于其位于维也纳第一区的私人寓所。维也纳警方表示，死因仍在调查中，尚未排除任何可能性。</p>

            <p>Lucius was born into one of Europe's most prominent industrial dynasties. His father, Heinrich Hoffmann, is the chairman of Hoffmann Industrial Group, a Bavarian steel conglomerate with estimated assets exceeding €1.2 billion. Despite the family's vast business empire, Lucius showed a passionate devotion to the piano from the age of five. A diligent and gifted student, he studied under the renowned Professor Hans Weber at the Vienna Conservatory, held his first solo recital at 16, and went on to perform at prestigious venues including the Vienna Musikverein and the Salzburg Festival. He was named in Forbes Europe's "30 Under 30" in the arts category and had been publicly praised by cultural ministers across multiple countries.</p>
            <p class="cn">Lucius出身于欧洲最显赫的工业家族之一。其父Heinrich Hoffmann是霍夫曼工业集团的董事长，该集团是一家总部位于巴伐利亚的钢铁企业，估计资产超过12亿欧元。尽管家族拥有庞大的商业帝国，Lucius自五岁起便对钢琴展现出热忱。他天资聪颖又勤奋刻苦，师从著名的Hans Weber教授在维也纳音乐学院学习，16岁举办首场独奏会，此后在维也纳金色大厅和萨尔茨堡音乐节等知名场馆演出。他曾入选《福布斯》欧洲"30位30岁以下精英"艺术类榜单，并受到多国文化部长的公开赞誉。</p>

            <p>"He was a genuinely gifted player — disciplined, emotional, technically strong," said Professor Hans Weber, his long-time mentor at the Vienna Conservatory. "But his published compositions... they existed on a different plane entirely from his playing. There was always a gap between the Lucius I taught and the Lucius on the page. I could never explain it."</p>
            <p class="cn">"他确实是一位有天赋的演奏者——自律、富有情感、技术扎实，"他在维也纳音乐学院的长期导师Hans Weber教授说。"但他发表的作品……与他的演奏完全不在一个层面上。我教的那个Lucius和乐谱上的Lucius之间总有一道鸿沟。我始终无法解释。"</p>
            ...
            <p>As of press time, Lucius's personal blog and social media accounts remain active. His last blog post was published on Novemberr 14th.</p>
            <p class="cn">截至发稿时，Lucius的个人博客和社交媒体账号仍保持活跃。他最后一篇博文发表于11月14日。</p>
        ...
        infoBox: {
            title: "Lucius",
            items: [
                { label: "Born", value: "12 January 1980" },
